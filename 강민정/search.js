const search = (function() {
  ...
  Search.prototype.insertArray = function(index) {
  ...
  Search.prototype.eventResult = function() {
  ...
  Search.prototype.moveInit = function() {
    if (!this.result.querySelector('.' + this.toggleClass)) {
  ...
  Search.prototype.removeMove = function() {
  ...
  Search.prototype.submit = function(value) {
