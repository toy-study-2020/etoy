...
Handlebars.registerHelper('regUrl', function(url) {
	return url.match( /[^ㄱ-ㅎ|ㅏ-ㅣ|가-힣]/g ).join('');
});

Handlebars.registerHelper('regNum', function(num) {
	return num.match( /[1-9]/g ).join('');
});

Handlebars.registerHelper('priceUnit', function(price) {
	return '$' + price
});
